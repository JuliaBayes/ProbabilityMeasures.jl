...
- The `RealLine`, `NonNegativeReals`, `RealInterval`, `IntegerRange`, `IntegerSimplex`
  and `RealVectors` supports. `PositiveReals` and `UnitInterval` will arrive with the
  first measure that needs one.
